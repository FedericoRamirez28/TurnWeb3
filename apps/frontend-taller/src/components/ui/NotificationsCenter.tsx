  ...
  return (
    <div className="notif">
      <button
        ...
        type="button"
      >
        <img className="notif__icon" src={unread ? bellActive : bell} alt="campana" />
        ...
        <div className="notif__panel">
          <div className="notif__head">
            ...
            <div className="notif__actions">
              <button className="btn-ghost" onClick={markAllRead} disabled={!items.length} type="button">
                Marcar leídas
              </button>
              <button className="btn-ghost" onClick={clearAll} disabled={!items.length} type="button">
                Vaciar
              </button>
            </div>
          </div>
            ...
            {items.map((n) => (
              <li key={n.id} className={`notif__item ${n.level} ${n.read ? 'read' : ''}`}>
                ...
                <div className="notif__item__right">
                  ...
                  <button className="chip danger" type="button" onClick={() => removeOne(n.id)}>
                    Eliminar
                  </button>
                </div>
              </li>
